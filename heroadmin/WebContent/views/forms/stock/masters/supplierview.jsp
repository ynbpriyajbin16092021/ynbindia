...
<jsp:include page="../../template/header.jsp" />
				...
				<div class="card">
                        <div class="card-header">
                            <strong class="card-title"><i class="fa fa-shopping-bag"></i> SUPPLIER List</strong>
						</div>
                          ...
                          <!-- Credit Card -->
							  <div id="pay-invoice">
								   <div class="width_100" >
										 ...
										 <a href="addsupplier" class="btn btn-secondary pull-right btnmove">New <i class="fa fa-plus-circle"></i></a>
											...
											<p class="select"><b>SUPPLIERS TITLE</b></p>
												...
												<div class="col-md-8 ">
													 <div class="pull-right">
						                                         <a href="supplier" class="btn btn-secondary pull-right btnnew">
                                                                   Back
                                                                 </a>
                                                      </div>
											</div> 
								...
								<tr> <td><b> Country  </b></td>  <td id="countrytdid"></td>  </tr>
															...
															<div class="col-md-12">
																	...
																	<table id="payables" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
