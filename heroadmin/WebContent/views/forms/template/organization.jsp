                          ...
                          <div class="container bgStyle">
                               ...
                               <div class="col-md-8 form-group">
                                ...
                                <div class="col-md-8 form-group">
                                 ...
                                 <div class="col-md-8 form-group">
									<div class="col-md-4" >
										<label for="needstock">Need stock transfer  <span style="color:red">*</span></label>
									</div>
									<div class="col-md-8">
										 <span class="checkbox-inline akucheckbox-inline"><input type="radio" name="gendertext" value="yes"  > YES</span>
		                                  <span class="checkbox-inline akucheckbox-inline1"><input type="radio" name="gendertext" value="no" checked> NO</span>	
                                   </div>
                                    </div>
								<div class="col-md-8 form-group">
									<div class="col-md-4">
                                ...
                                <div class="col-md-12 form-group">
                                	...
                                	<div class="width_75">
                                		...
                                		<div class="col-md-8">
											<iframe src="/heroadmin/forms/heroupload?name=companylogo.jpg&applntype=0&requesttype=2" id="imgpathtext"
