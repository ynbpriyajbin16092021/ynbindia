<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <script src="/heroadmin/js/lib/theme/bootstrap-datepicker.js"></script>
...
<script src="/heroadmin/js/lib/theme/popper.min.js"></script> 
  <script src="/heroadmin/js/lib/theme/plugins.js"></script>
	...
	<script type="text/javascript" src="/heroadmin/js/lib/theme/jquery.dataTables.min.js"></script>
	<script type="text/javascript" src="/heroadmin/js/lib/theme/dataTables.bootstrap.min.js"></script>
	<script type="text/javascript" src="/heroadmin/js/lib/theme/dataTables.responsive.min.js"></script>	
	<script type="text/javascript" src="/heroadmin/js/lib/theme/responsive.bootstrap.min.js"></script>
