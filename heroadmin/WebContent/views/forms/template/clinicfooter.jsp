...
<div class="clearfix"></div>
    ...
    <script src="../js/lib/theme/bootstrap-datepicker.js"></script>
	<script type="text/javascript" src="../js/lib/theme/moment.2.10.3.js"></script>
	<script type="text/javascript" src="../js/lib/theme/daterangepicker.2.1.27.js"></script>
	<script type="text/javascript">
...
<script src="../js/lib/theme/popper.min.js"></script> 
  <script src="../js/lib/theme/plugins.js"></script>
	
   
   <!-- <script src="assets/js/main.js"></script> -->
	<script type="text/javascript" src="../js/lib/theme/jquery-ui.js"></script>
	<script type="text/javascript" src="../js/lib/theme/jquery.dataTables.min.js"></script>
	<script type="text/javascript" src="../js/lib/theme/dataTables.bootstrap.min.js"></script>
	<script type="text/javascript" src="../js/lib/theme/dataTables.responsive.min.js"></script>	
	<script type="text/javascript" src="../js/lib/theme/responsive.bootstrap.min.js"></script>
