...
public class HERO_ADM_SERVC_VIEWIMAGES extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final int DEFAULT_BUFFER_SIZE = 10240; // 10KB.
	private String filePath;
	private static Logger log = Logger.getLogger(HERO_ADM_SERVC_VIEWIMAGES.class);
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HERO_ADM_SERVC_VIEWIMAGES() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!file.exists()) {
            ...
            return;*/
        	filePath = request.getServletContext().getRealPath("")+File.separator+"logos"+File.separator+"defaultlogo.jpg";
