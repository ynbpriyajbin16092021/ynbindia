...
public class HERO_ADM_SERVC_ERPSECURITYHANDLER implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest req, HttpServletResponse res,
		...
		if(!url.endsWith("login") && !url.endsWith("organization") && !url.endsWith("heroupload") && !url.endsWith("uploadFile")&& !url.endsWith("registerforgotpassword") && !url.endsWith("HERO_TOKEN_VALIDATOR"))
		{
