...
public class HERO_ADM_SERVC_EXPIRYDATECHECKERDAOIMPL extends HERO_ADM_SERVC_INVENTORYDAO  implements HERO_ADM_SERVC_iEXPIRYDATECHECKERDAO {

	private static Logger log = Logger.getLogger(HERO_ADM_SERVC_EXPIRYDATECHECKERDAOIMPL.class);
	@Override
