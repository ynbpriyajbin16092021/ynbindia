...
public class HERO_ADM_SERVC_BARCODEDAOIMPL extends HERO_ADM_SERVC_INVENTORYDAO implements HERO_ADM_SERVC_iBARCODEDAO{
	private static Logger log = Logger.getLogger(HERO_ADM_SERVC_BARCODEDAOIMPL.class);
