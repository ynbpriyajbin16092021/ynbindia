...
public class HERO_ADM_SERVC_FILEUPLOAD extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(HERO_ADM_SERVC_FILEUPLOAD.class);
	private static final String SAVE_DIR = "inventoryFiles";
	
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HERO_ADM_SERVC_FILEUPLOAD() {
        super();
