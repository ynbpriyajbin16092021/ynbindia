<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<script type="text/javascript" src="/heroadmin/js/lib/theme/header.js"></script>
	...
	<link href="/heroadmin/resources/css/lib/datatable/buttons.dataTables.min.css" rel="stylesheet" type="text/css"/>
