...
<div class="clearfix"></div>
					<div class="breadcrumbs"  style="display: <%= request.getParameter("disp") %>">
			            <div class="col-md-4 col-sm-4">
			                <div class="page-header">
			                        <p class="cursor-pointer mar-top-10 bread-a-style head-font-size yellow-font" href="stockdashboard"><strong>Sales Order Making</strong></p>
			                </div>
			            </div>
          ...
          <div class="col-md-7 margin-bottom-12 margin-top-10" >
			<div style="padding-left: 164px;">
 			...
 			<div>
 			<button type="button" class="button-bg button-space pull-right" onclick="generateorderreceivingreport(2);" >Generate Report</button>
										...
										<div class="col-md-12 ">
										    ...
										    <div class="rowNor marginTop">
											 ...
											 <table id="ordermakingDT"  class="hero-settings-table" style="width:100%">
																	 <thead>
                                                                               <tr>
											                                      <th> SL.NO </th>
											                                      <th> Dish Name  </th>  
