...
<title>Sales by PaymentType Report</title>
					...
					<div class="breadcrumbs"  style="display: <%= request.getParameter("disp") %>">
			            <div class="col-md-4 col-sm-4">
			                <div class="page-header">
			                        <p class="cursor-pointer mar-top-10 bread-a-style head-font-size yellow-font" href="stockdashboard"><strong>Sales By PaymentType</strong></p>
			                </div>
			            </div>
						    ...
						    <jsp:include page="../template/reportfilter.jsp" />
										    ...
										    <div class="rowNor marginTop">
											   <div class="Report-header text-center">
									            ...
									            <h4>Sales by PaymentType Report</h4>
