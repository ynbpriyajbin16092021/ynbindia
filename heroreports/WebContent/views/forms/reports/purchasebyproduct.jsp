...
<title>Purchase by Product</title>
...
<body onload="loadreport();loadproducts();"> 
...
<div class="clearfix"></div>
					<div class="breadcrumbs"  style="display: <%= request.getParameter("disp") %>">
			            <div class="col-md-4 col-sm-4">
			                <div class="page-header">
			                        <p class="cursor-pointer mar-top-10 bread-a-style head-font-size yellow-font" href="stockdashboard"><strong>Purchase by Product</strong></p>
			                </div>
			            </div>
					...
					<div class="col-md-8 form-group">
						...
						<input type="text" class="form-control form-white" onblur="checkAvailableProduct()"
						 id="itemcodetext"  placeholder="Please select Product" autocomplete="off"></input>
                      	<input type="hidden" id="productcodetext" value="0"></input>
						    ...
						    <%-- <jsp:include page="../template/reportfilter.jsp" /> --%>
 										...
 										<div class="col-md-4 margin-bottom-12 margin-top-10" >
											<button type="button" class="button-bg button-space" 
											onclick="generatePurchaseByProductreport('reportDT');" >Generate Report</button>
												</div>	
										...
										<div class="col-md-12 ">
										    ...
										    <div class="rowNor marginTop">
											   <div class="Report-header text-center">
									            ...
									            <h5><span>From</span>&nbsp;<label id="startdatelabel"></label> 
									            <span>To</span> &nbsp; <label id="enddatelabel"></label> </h5>
									          </div>
