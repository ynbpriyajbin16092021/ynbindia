...
<title>Output Quantity Report</title>
					...
					<div class="breadcrumbs"  style="display: <%= request.getParameter("disp") %>">
			            <div class="col-md-4 col-sm-4">
			                <div class="page-header">
			                        <p class="cursor-pointer mar-top-10 bread-a-style head-font-size yellow-font" href="stockdashboard"><strong>Output Quantity Report</strong></p>
			                </div>
			            </div>
					...
					<div class="col-md-12 overcome-col-padd-10  ">
						   ...
						   <%-- <jsp:include page="../template/reportfilter.jsp" />  --%>
						    ...
						    <div class="col-md-6 form-group control-label" >
									...
									<select	id='transferid' class="form-control form-white">
										<option value="0">-- Select --</option>
										<c:forEach items="${transferList}" var="taxtype">
 										...
 										<div class="col-md-4 margin-bottom-12 margin-top-10" >
											<button type="button" class="button-bg button-space pull-right" onclick="generateOutputQtyReport('reportDT');" >Generate Report</button>
												</div>	
										...
										<%-- 	   <div class="Report-header text-center">
											 ...
											 <table id="outputQtyDT"  class="hero-settings-table" style="width:100%">
																	 <thead>
																		  <tr>
																			 <th>TRANSFER CODE</th>																			
																			 <th>PRODUCT NAME</th>   
