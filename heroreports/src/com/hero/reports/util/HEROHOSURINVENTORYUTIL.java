...
public class HEROHOSURINVENTORYUTIL{
	...
	public static HERO_RTS_RESPONSE returnResponse(Map<String, Object> resultMap,HERO_RTS_RESPONSE inventoryResponseOBJ)
	{
		if(resultMap != null)
		{
	...
	public static HERO_RTS_RESPONSE returnExceptionResponse(HERO_RTS_RESPONSE inventoryResponseOBJ,Exception e)
	{
