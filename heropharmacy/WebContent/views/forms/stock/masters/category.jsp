					...
					<div class="breadcrumbs"  style="display: <%= request.getParameter("disp") %>">
			            <div class="col-md-4 col-sm-4">
			                <div class="page-header">
			                        <p class="cursor-pointer mar-top-10 bread-a-style head-font-size yellow-font" href="stockdashboard"><strong>Category Master</strong></p>
			                </div>
			            </div>
						...
						<div class="col-md-5 overcome-col-padd-10 ">
							<div class="width_100">
								<div class="width_100 gray-font white-bg content-font-size side-content-height content-div-height">
									...
									<div class="col-md-12 full-padding-20">
										<div class="width_100">
											<button class="button-bg button-space pull-right mar-bot-15 mar" onclick="clearCategoryFormValues()()">New <i class="fa fa-plus-circle"></i></button>
										</div>
										<div class="clearfix"></div>
										<div class="margin-bottom-10 content-font-size  white-font color-bg">
											<p class="padd-left-right-5"> Category </p>
										</div>
										<div class="col-md-12 form-group" >
										   <label for="Manufacturer Company Name">Categories Name <span style="color:red">*</span></label>
										   ...
										   <div class="col-md-12 permissionDiv">
			                         			<button  class="btn btn-primary" type="button" onclick="savecategory()">Save</button>
									     		<button  class="btn btn-default" type="button"  onclick="clearCategoryFormValues();">Clear</button>
									     		</div>
			                      			</div>
										</div>
