...
<body onload="loaduom();loaduomsetting();">
					...
					<div class="breadcrumbs"  style="display: <%= request.getParameter("disp") %>">
			            <div class="col-md-4 col-sm-4">
			                <div class="page-header">
			                    <p class="cursor-pointer mar-top-10 bread-a-style head-font-size yellow-font" href="stockdashboard"><strong><i class="fa fa-users"></i>  UOM Master</strong></p>
			                </div>
			            </div>
	...
	<!-- 			<div class="col-md-12 overcome-col-padd-10">
						...
						<div class="col-md-6 overcome-col-padd-10">
							...
							<div class="width_100" >
								<div class="width_100 gray-font white-bg content-font-size content-div-heightnw" id="style-5">
									...
									<label for="SupplierType">UOM Desc <span style="color:red">*</span></label>
									...
									<div class="col-md-12 form-group">
									<label for="SupplierType">UOM Code <span style="color:red">*</span></label>
						...
						<div class="col-md-6 overcome-col-padd-10">
							...
							<div class="width_100"  id="uomsettingsdivid">
								<div class="width_100 gray-font white-bg content-font-size content-div-heightnw" id="style-5">
									<div class="col-md-12 full-padding-20">
										 <div class="width_100" >
						<button class="button-bg button-space pull-right mar-bot-15 mar" onclick="clearUOMSettings()">New <i class="fa fa-plus-circle"></i></button>
										</div>
										<div class="clearfix"></div>
									<div class="margin-bottom-10 content-font-size  white-font color-bg" >
					...
					<div class="width_100"  id="adduomsettingsdivid" style="display: none;">
								<div class="width_100 gray-font white-bg content-font-size content-div-heightnw" id="style-5">
									<div class="col-md-12 full-padding-20">
										<div class="width_100">
											<button class="button-bg button-space mar-bot-15 mar" onclick="showuomsettingsdivid()">New <i class="fa fa-plus-circle"></i></button>
