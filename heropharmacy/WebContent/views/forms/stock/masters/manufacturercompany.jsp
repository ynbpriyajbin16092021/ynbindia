					...
					<div class="breadcrumbs"  style="display: <%= request.getParameter("disp") %>">
			            <div class="col-md-4 col-sm-4">
			                <div class="page-header">
			                        <p class="cursor-pointer mar-top-10 bread-a-style head-font-size yellow-font" href="stockdashboard"><strong> Manufacturer Master</strong></p>
			                </div>
			            </div>
							...
							<div class="width_100">
								<div class="width_100 gray-font white-bg content-font-size content-div-height">
									...
									<div class="width_100">
											...
											onclick="clearCompanyFields()">New <i class="fa fa-plus-circle"></i></button>
									</div>
									<div class="clearfix"></div>
									
									<div class="margin-bottom-10 content-font-size  white-font color-bg">
											<p class="padd-left-right-5">Manufacturer Name </p>
										</div>
									<div  id="masterCollapse" >
									   <label for="Manufacturer Company Name">Manufacturer Name <span style="color:red">*</span></label>
									   ...
									   <div class="col-md-12 permissionDiv">
		                         			<button data-dismiss="modal" class="btn btn-primary" type="button" onclick="savecompany()">Save</button>
								     		<button data-dismiss="modal" class="btn btn-default" type="button"  onclick="clearCompanyFields();">Clear</button>
								     		</div>
		                      			</div>
									</div>
