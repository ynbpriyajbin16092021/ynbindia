...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Removed Purchase Order View</title>
    <jsp:include page="../template/library.jsp" />
</head>
<body onload="viewdeletedpo()"> 
					...
					<div class="breadcrumbs"  style="display: <%= request.getParameter("disp") %>">
			            <div class="col-md-4 col-sm-4">
			                <div class="page-header">
			                        <div class="lowstockspan yellow-font"><strong class="card-title"><i class="fa fa-shopping-cart"></i> Removed Purchase Order View </strong></div>
			                </div>
			            </div>
							...
							<div class="width_100">
								...
								<div class="width_100 gray-font white-bg content-font-size content-div-height">
									<div class="col-md-12 full-padding-20">
										<table  class="hero-settings-table"  style="width:100%" id="viewdelDT">
	                                        <thead>
	                                            <tr>
	                                               <th> # </th>
	                                               <th>Purchasecode</th>
