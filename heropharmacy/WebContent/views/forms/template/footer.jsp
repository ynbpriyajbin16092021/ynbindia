...
<div class="modal fade" id="modal-delet-po" tabindex="-1" role="dialog" aria-hidden="true">
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">&times;</button>
    ...
    <div class="modal-body">
      <div class="popDel" align="center">
        ...
        <div class="col-md-12" style="padding-bottom:25px;">
        	<div class="col-md-5">
        	 <label class="form-label">Reason for deleting?</label>
        	</div>
        	<div class="col-md-7">
 			 <input type="text" class="form-control" id="poRemarks"  />
        	</div>
        </div>
      </div>
    </div>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="popDel" align="center">
        <p style="text-align:center" id="confirmationMsg">Are you sure?</p>
      </div>
    </div>
    <div class="modal-footer alignCenter" align="center ">
      <button type="button" class="btn btn-primary confirmResult" data-value ="true" data-dismiss="modal" >Yes</button>
      <button type="button" class="btn btn-danger confirmResult"  data-value ="false" data-dismiss="modal"  >Cancel</button>
    </div>
  </div>
</div>
</div>
