					...
					<div class="breadcrumbs"  style="display: <%= request.getParameter("disp") %>">
			             <div class="col-md-4 col-sm-4">
			                <div class="page-header">
			                        <a class="cursor-pointer bread-a-style content-font-size color-font" href="stockdashboard"><strong style="font-size:15px;">PurchaseOrder History</strong></a>
			                </div>
			            </div>
                                         			...
                                         			<%-- <td>
                                         				<c:choose>    
					                                             <c:when test="${purchaseOrder.receivestatus != 3}"> 
																    ...
																    <span><a class="text-decoration-underline color-font" href="receivestock?pid=${purchaseOrder.purchaseid }">Receive Stock</a></span>
																	<% } %>
																</c:when> 
														 		<c:otherwise>
																</c:otherwise>
