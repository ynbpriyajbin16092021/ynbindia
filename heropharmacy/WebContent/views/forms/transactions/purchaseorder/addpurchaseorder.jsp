...
<body onload="loadaddpurchaseorder();loadPurchaseApprovedItems();">
					...
					<div class="breadcrumbs"  style="display: <%= request.getParameter("disp") %>">
			            <div class="col-md-4 col-sm-4">
			                <div class="page-header">
			                        <p class="cursor-pointer mar-top-10 bread-a-style head-font-size yellow-font" href="stockdashboard"><strong>New Purchase Order</strong></p>
			                </div>
			            </div>
...
<input type="hidden" value="<%=session.getAttribute("uid")%>" id="herouseridtext">
                   	<div class="col-md-12 overcome-col-padd-10  ">
                        ...
                        <div class="card-body">
                          ...
                          <div class="col-md-6 form-group">
									   ...
									   onchange="loadPurchaseApprovedItems()">
									...
									<div class="col-md-6 form-group purchaseordernumberDiv">
                                     ...
                                     <div class="col-md-6 form-group" style="display:none">
									   ...
									   <select id='storeidselect' class="form-control form-white selectSer" value="1">
							...
							<div class="col-md-12 margin-top-20">
									...
									<div class="col-md-6 form-group">
									<label for="Product" >Net Amount</label>
								 
								   <p id="netamounttext"></p>
								   </div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
						<div class="col-md-12">
							<p>You cannot edit this purchase order. Please confirm to proceed</p>
						</div>
				</div> 
				<div class="modal-footer">
				<button type="button" class="btn btn-primary"
						onclick="savepurchaseorder()" style="margin: 8px 4px;">save</button>
