...
<c:forEach items="${posList}" var="print" >  
...
<div class="col-sm-3">
 ...
 <c:forEach items="${posList}" var="order" > 
...
<tbody>
      <c:forEach items="${positemList}" var="order" > 
     <tr>
           <td  class="bgcolor border-bottom">${order.index+1 }</td>
           <td  class=" border-bottom" style=" text-align: left!important;"><p style="font-weight:bold;"></p></br>-${order.productname }</td>
           <td  class="border-bottom">${order.batch}</td>
           <td  class="border-bottom">${order.salescount}</td>
           <td  class="bgcolor border-bottom">${order.salesprice }</td>
           <td  class="border-bottom">${order.subtotal }</td>
           <td  class="border-bottom">${order.taxamt }</td>
           <td  class="bgcolor align border-bottom">${order.netamount }</td>
     </tr>
    ...
    <tr style="height:120px; border-bottom: 2px solid #0099CC;">
     ...
     <td  class="bgcolor "></td>
       ...
       <td  class="bgcolor ">${print.grandtotal }</td>
        <td ></td>
         <td  class="bgcolor ">${print.netamount }</td>
        <td></td>
...
<div class="col-sm-8 " align="right">
  ...
  <div class="col-sm-4 " align="right">
   <p class="font-style"> Rs.${order.netamount }</p>
