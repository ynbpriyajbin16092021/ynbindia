...
function productinfo(productObj)
{
	...
	$('#cgstid').text(productObj.cgst);
	$('#sgstid').text(productObj.sgst);
	$('#hsncode').text(productObj.hsncode);
...
function getsupplierdetails(supplierid)
{
	...
	$.ajax({
		...
		success:function(data,textStatus,jqXHR)
		{
			...
			if(responseType == 'S')
				{
				var purchasedList = responseValue['purchasedList'];
				var purchaseList = responseValue['purchaseList'];
				...
				var supplierObj = purchasedList[0];
...
function supplierinfo(supplierObj)
{
	...
	$('#paymodeid').text(supplierObj.paymode);
	$('#orderedid').text(supplierObj.orderedqty);
	$('#receivedid').text(supplierObj.receivedqty);
	$('#balanceid').text(supplierObj.balance);
}
