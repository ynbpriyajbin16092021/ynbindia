package com.hero.stock.controller.services.toolsmodule;
...
import com.hero.stock.forms.services.tools.barcode.HERO_STK_SERVC_BARCODEHELPER;
import com.hero.stock.forms.services.tools.barcode.HERO_STK_SERVC_iBARCODEDAO;
import com.hero.stock.forms.services.tools.expirydatechecker.HERO_STK_SERVC_EXPIRYDATECHECKERHELPER;
import com.hero.stock.forms.services.tools.expirydatechecker.HERO_STK_SERVC_iEXPIRYDATECHECKERDAO;
import com.hero.stock.forms.services.tools.lowstock.HERO_STK_SERVC_ILOWSTOCKDAO;
import com.hero.stock.forms.services.tools.lowstock.HERO_STK_SERVC_LOWSTOCKHELPER;
import com.hero.stock.forms.services.tools.stockmonitor.HERO_STK_SERVC_ISTOCKMONITORDAO;
import com.hero.stock.forms.services.tools.stockmonitor.HERO_STK_SERVC_STOCKMONITORHELPER;
import com.hero.stock.lov.HERO_STK_IINVENTORYLOV;
import com.hero.stock.util.HERO_STK_INVENTORYDAO;


@Controller
public class HERO_STK_SERVC_TOOLSMODULE extends HERO_STK_INVENTORYDAO{
	...
	@Autowired
	protected HERO_STK_SERVC_EXPIRYDATECHECKERHELPER expirydateHelperOBJ;
	@Autowired
	protected HERO_STK_SERVC_iEXPIRYDATECHECKERDAO iexpirydateDAOOBJ;
	
	@Autowired
	protected HERO_STK_SERVC_BARCODEHELPER barcodeHelperOBJ;
	@Autowired
	protected HERO_STK_SERVC_iBARCODEDAO ibarcodeDAOOBJ;
	...
	@RequestMapping(value="/purchaseorderdelhistory",method=RequestMethod.GET)
	@Produces(MediaType.APPLICATION_JSON)
	@ResponseBody
	public ResponseEntity<Object> getPurchaseOrderdelHistory(HttpServletRequest httpRequest)
	{
		List<Object> purchaseorderdelhistoryList = inventoryLOVobj.getPurchaseOrderdelHistory(httpRequest);
		inventoryResponseOBJ.setResponseType("S");
		inventoryResponseOBJ.setResponseObj(purchaseorderdelhistoryList);
	...
	@RequestMapping(value="/purchaseorderdelhistoryview/{poid}",method=RequestMethod.GET)
	@Produces(MediaType.APPLICATION_JSON)
	@ResponseBody
	public ResponseEntity<Object> getpurchaseorderdelhistoryview(HttpServletRequest httpRequest,@PathVariable("poid")String poid)
	{
		List<Object> purchaseorderdelhistoryList = inventoryLOVobj.getpurchaseorderdelhistoryview(httpRequest,poid);
		inventoryResponseOBJ.setResponseType("S");
		inventoryResponseOBJ.setResponseObj(purchaseorderdelhistoryList);
	...
	@RequestMapping(value="/updatereadnotificationstatus/{poid}",method=RequestMethod.POST)
	@Produces(MediaType.APPLICATION_JSON)
	@ResponseBody
	public ResponseEntity<Object> updatereadnotificationstatus(HttpServletRequest httpRequest,@PathVariable("poid")String poid)
	{
		List<Object> purchaseorderdelhistoryList = inventoryLOVobj.updatereadnotificationstatus(httpRequest,poid);
		inventoryResponseOBJ.setResponseType("S");
		inventoryResponseOBJ.setResponseObj(purchaseorderdelhistoryList);
