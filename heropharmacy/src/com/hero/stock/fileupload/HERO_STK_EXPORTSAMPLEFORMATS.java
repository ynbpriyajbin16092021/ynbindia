...
public class HERO_STK_EXPORTSAMPLEFORMATS extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final int DEFAULT_BUFFER_SIZE = 10240; // 10KB.
	private String filePath;
	private static Logger log = Logger.getLogger(HERO_STK_EXPORTSAMPLEFORMATS.class);
	private static Logger error_log = Logger.getLogger("requestAppender");
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HERO_STK_EXPORTSAMPLEFORMATS() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.filePath = request.getServletContext().getRealPath("")+File.separator+"resources"+
		File.separator+"sampleformats"+File.separator+"productimportsample.xlsx";
